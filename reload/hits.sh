...
cat <<SQL | bendsql
  CREATE TABLE hits (
    WatchID BIGINT UNSIGNED NOT NULL,
    JavaEnable SMALLINT NOT NULL,
    Title VARCHAR NOT NULL,
    GoodEvent SMALLINT NOT NULL,
    EventTime TIMESTAMP NOT NULL,
    EventDate Date NOT NULL,
    CounterID INTEGER UNSIGNED NOT NULL,
    ...
    AdvEngineID SMALLINT UNSIGNED NOT NULL,
    ...
    FUniqID BIGINT UNSIGNED NOT NULL,
    ...
    RemoteIP BIGINT UNSIGNED NOT NULL,
    ...
    ResponseStartTiming INTEGER UNSIGNED NOT NULL,
    ResponseEndTiming INTEGER UNSIGNED NOT NULL,
    FetchTiming INTEGER UNSIGNED NOT NULL,
    SocialSourceNetworkID SMALLINT NOT NULL,
    SocialSourcePage VARCHAR NOT NULL,
    ParamPrice BIGINT UNSIGNED NOT NULL,
    ...
    RefererHash BIGINT UNSIGNED NOT NULL,
    URLHash BIGINT UNSIGNED NOT NULL,
